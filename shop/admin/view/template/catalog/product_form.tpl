          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="model" value="Crop" placeholder="<?php echo $entry_model; ?>" id="input-model" class="form-control" />
                  <?php if ($error_model) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <!-- <input type="text" name="minimum" value="100" placeholder="<?php echo $entry_minimum; ?>" id="input-minimum" class="form-control" /> -->
                </div>
              </div>
              <div class="form-group">
